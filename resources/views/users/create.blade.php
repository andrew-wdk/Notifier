            ...
            <div class="box-body">
                ...
                <div class="row">
                    <div class="form-group margin-bottom20 col-md-6">
                        ...
                        {{ Form::text('email',old('email'),['id'=>'email','required' => 'required','class' => 'form-control']) }}
                ...
                <div class="row">
                    <div class="form-group margin-bottom20 col-md-6">
                        ...
                        {{ Form::text('password',old('password'),['id'=>'password','required' => 'required','class' => 'form-control']) }}
