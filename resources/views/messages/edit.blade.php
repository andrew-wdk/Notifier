...
{{ Form::open(['route' => ['messages.update',$resource->id],'method' => 'PATCH','enctype'=>'multipart/form-data']) }}
            ...
            <div class="box-body">
                ...
                <div class="row">
                    <div class="form-group margin-bottom20 col-md-6">
                        ...
                        {{ Form::text('body',$resource->body,['id'=>'body','required' => 'required','class' => 'form-control']) }}
